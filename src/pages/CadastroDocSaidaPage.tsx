          ...
          <div className="space-y-4 py-2">
              ...
              <ProdutoSearchInput
                ...
                onChange={(p) => {
                  ...
                  setItemForm((f) => ({
                    ...f,
                    produto_id: p?.id ?? "",
                    valor_unit: Number(p?.preco_custo ?? 0),
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    setItemForm((f) => ({ ...f, quantidade: qty, valor_total: qty * f.valor_unit }));
                  }}
              ...
              <div>
                ...
                <input
                  readOnly
                  value={itemForm.valor_unit.toLocaleString("pt-BR", { style: "currency", currency: "BRL" })}
